...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'Company Policy Update.update': {
    roles: ['business-owner', 'hr-manager', 'payroll-administrator', 'employee', 'accountant', 'qa'],
    key: 'policy_update',
    tenantPath: [],
    userPath: [],
  },
  'Employee Benefits Update.update': {
    roles: ['business-owner', 'payroll-administrator', 'employee', 'accountant', 'qa'],
    key: 'benefits_update',
    tenantPath: [],
    userPath: [],
  },
  'Payroll Processed.update': {
    roles: ['business-owner', 'hr-manager', 'employee', 'accountant', 'qa'],
...
const ownerRoles: string[] = ['qa'];
const customerRoles: string[] = ['admin'];
const tenantRoles: string[] = ['business-owner', 'hr-manager', 'payroll-administrator', 'employee', 'accountant', 'qa'];
