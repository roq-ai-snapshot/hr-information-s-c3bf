...
import { getHrInformationById } from 'apiSdk/hr-informations';
import { HrInformationInterface } from 'interfaces/hr-information';

function HrInformationViewPage() {
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                <Box>
                  ...
                  >
                    Hr Information Details
                  </Text>
                </Box>
                {hasAccess('hr_information', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/hr-informations/edit/${id}`} passHref legacyBehavior>
                    <Button
