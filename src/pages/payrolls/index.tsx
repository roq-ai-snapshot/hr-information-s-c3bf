  ...
  const columns: ColumnType[] = [
    {
      ...
      cell: ({ row: { original: record } }: any) =>
        record?.pay_period_start ? format(parseISO(record?.pay_period_start as unknown as string), 'dd-MM-yyyy') : '',
    },
    {
      id: 'pay_period_end',
      ...
      cell: ({ row: { original: record } }: any) =>
        record?.pay_period_end ? format(parseISO(record?.pay_period_end as unknown as string), 'dd-MM-yyyy') : '',
    },
