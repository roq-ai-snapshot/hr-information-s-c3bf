...
export function EmployeeListPage(props: EmployeeListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getEmployees({
        relations: ['user', 'company', 'hr_information.count', 'payroll.count', 'vacation.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('company', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('hr_information', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'hr_information',
          header: 'Hr Information',
          accessorKey: 'hr_information',
          cell: ({ row: { original: record } }: any) => record?._count?.hr_information,
        }
      : null,
